...
<style>
    ...
    .flexbox-fields select#feestatus {
      width: 130px;
    }
...
<div class="row">
    ...
    <div class="form-group">
    <label for="billing_facility"><?php echo xlt('Billing Location'); ?>:</label>
        <?php
...
<div class="row">
  <div class="flexbox-fields">
    ...
    //Get EMOTICON (status)
    $smileyRes = sqlQuery("SELECT status FROM openemr_postcalendar_events_additional WHERE pc_eid = ?", array($eid));
    $smileyStatus = (isset($smileyRes['status']) && $smileyRes['status']) ? $smileyRes['status'] : '';

    if($feeStatusOptions) { ?>
    <div class="form-group flexfield">
      <label id='title_feestatus'><?php echo ($status_label) ? xlt($status_label) : 'Unknown'; ?>:</label>
